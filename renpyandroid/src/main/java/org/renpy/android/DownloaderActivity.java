...
public class DownloaderActivity extends Activity implements IDownloaderClient {
    ...
    private void initializeDownloadUI() {
        ...
        mPauseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(DownloaderActivity.this, "Failed to create IDownloaderService, please restart the game", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (expansionFile == null) {
            ...
            initializeBasicUI();
            boolean needDownload = tryStartDownload();
...
/*
    ...
    //Returns true if need download, and false if already downloaded
    protected boolean tryStartDownload()
    {
    ...
    public  boolean isStoragePermissionGranted() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                Log.v("DownloaderActivity","Permission is granted");
                return true;
            } else {

                Log.v("DownloaderActivity","Permission is revoked");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
            Log.v("DownloaderActivity","Permission: "+permissions[0]+ "was "+grantResults[0]);
